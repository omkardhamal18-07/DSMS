    ...
    <div class="wrapper">
        ...
        <nav id="sidebar" class="sidebar shadow">
            ...
            <ul class="list-unstyled components">
                ...
                <li class="active"><a href="issue_stationery.php"><i class="fas fa-dolly"></i> Issue Stationery</a></li>
                <li><a href="#"><i class="fas fa-tags"></i> Categories</a></li>
                <li><a href="#"><i class="fas fa-chart-pie"></i> Reports</a></li>
                <li><a href="faculty_requests.php?status=PENDING"><i class="fas fa-bell"></i> Notifications <?php if($pending_count > 0): ?><span class="badge bg-danger rounded-pill float-end"><?php echo $pending_count; ?></span><?php endif; ?></a></li>
            ...
            <nav class="navbar navbar-expand-lg navbar-light bg-white shadow-sm mb-4 rounded-3 top-navbar">
                <div class="container-fluid">
                    ...
                    <div class="d-none d-sm-block ms-3">
                        <h5 class="mb-0 text-gray-800">Issue Stationery</h5>
                    </div>
