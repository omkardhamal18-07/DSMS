...
document.addEventListener("DOMContentLoaded", function () {
    ...
    Chart.defaults.color = ThemeEngine && ThemeEngine.isDarkModeActive() ? '#CBD5E1' : '#858796';
        ...
        const monthlyChart = new Chart(ctxMonthly, {
            ...
            options: {
                ...
                scales: {
                    ...
                    y: {
                        grid: { color: ThemeEngine && ThemeEngine.isDarkModeActive() ? "#334155" : "rgb(234, 236, 244)", drawBorder: false, borderDash: [2] },
                        ticks: { maxTicksLimit: 5, padding: 10 }
                    }
                }
            }
        });
        window.dsmsCharts.push(monthlyChart);
    }
    ...
    if (ctxPie) {
        const pieChart = new Chart(ctxPie, {
            ...
            data: {
                ...
                datasets: [{
                    ...
                    hoverBorderColor: ThemeEngine && ThemeEngine.isDarkModeActive() ? "#1E293B" : "rgba(234, 236, 244, 1)",
                }]
            },
            options: {
                maintainAspectRatio: false,
        ...
        window.dsmsCharts.push(pieChart);
    }
    ...
    if (ctxWeekly) {
        ...
        window.dsmsCharts.push(weeklyChart);
    }
